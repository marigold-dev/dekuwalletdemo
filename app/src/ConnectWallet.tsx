import {
  DekuPermissionRequest,
  DekuPermissionResponse,
  DekuPermissionScope,
...
const ConnectButton = ({ Tezos, setUserAddress }: ButtonProps): JSX.Element => {
    ...
    try {
      ...
      const dekuPermissionRequest: DekuPermissionRequest = {
        ...
        blockchainData: {
          ...
          scopes: [DekuPermissionScope.transfer, DekuPermissionScope.sign],
          network: {
      ...
      let permissions: DekuPermissionResponse = (await Tezos.permissionRequest(
        dekuPermissionRequest as PermissionRequestV3<"deku">
      )) as DekuPermissionResponse;
